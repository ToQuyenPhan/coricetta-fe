...
function UserMenu() {
  ...
  const fetchMenusData = async () => {
    const res = await fetch("https://localhost:44327/api/Menus/allUserMenu?currentPage=1&pageSize=3", {
  ...
  const fetchHeroData = async () => {     
    const res = await fetch("https://localhost:44327/api/Menus/allUserMenu?currentPage=1&pageSize=3", { mode: 'cors', method: 'GET', headers: new Headers({
        'Authorization': `Bearer ${token}`, 
        'Content-Type': 'application/json',
    ...
    <div className="w-full">
      ...
      <div>
        ...
        <div className="max-w-[1640px] m-auto px-4 py-12">
          <h1 className="text-orange-600 font-bold text-4xl text-center">Các thực đơn của bạn</h1>
        </div>
