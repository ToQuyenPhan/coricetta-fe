...
function Home() {
  ...
  let url = `https://localhost:44327/api/Recipes/all?currentPage=${currentPage}&pageSize=2&recipeStatus=1`;
  ...
  const fetchRecipeData = async (level, category) => {
    ...
    const res = await fetch(`https://localhost:44327/api/Recipes/all?currentPage=${currentPage}&pageSize=2&recipeStatus=1`, {
