...
export const Tooltip = ({ position, content, children }) => (
  <div id="tooltip" className="relative cursor-pointer group max-w-[50px]">
    ...
    <span
      className={classNames(
        ...
        position === "left"
          ...
          : "",
        position === "right"
          ? "top-1/2 -translate-y-1/2 left-[calc(50px)]"
          : ""
      )}
    >
      {content}
    ...
    <span
      className={classNames(
        ...
        position === "left"
          ...
          : "",
        position === "right"
          ? "top-1/2 -translate-y-1/2 left-[calc(45px)] border-t-transparent border-b-transparent border-l-0 border-r-neutral-900"
          : ""
      )}
    ></span>
  </div>
